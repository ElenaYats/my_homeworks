...
def test_rectangle_square_add_area_positive(rectangle_sides, square_side):
    ...
    assert Figure.add_area(rectangle, square) == expected_area, f"Wrong value square + rectangle"
...
def test_rectangle_rectangle_add_area_positive(rectangle1_sides, rectangle2_sides):
    ...
    assert Figure.add_area(rectangle1, rectangle2) == expected_area, f"Wrong value rectangle + rectangle"